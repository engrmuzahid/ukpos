...
<table id="contents">
	<tbody><tr>
        ...
        <?php echo CHtml::beginForm('/pos_uk/customer_invoice/add','post',array( 'enctype'=>'multipart/form-data')); ?>
       <table  width="90%"  cellpadding="0" cellspacing="0"  style="margin-bottom:10px; margin-left:5px;">  
        <tr><td colspan="7">&nbsp;</td></tr>
				...
				<tr>
                    ...
                    <th width="15%" scope="col">Price + Vat</th>
                ...
                <?php				      
				 ...
				 ?>
				<tr>
                    <td width="5%"><input type="checkbox" name="<?php echo 'checkbox_'.$ProVal->id; ?>" id="<?php echo 'checkbox_'.$ProVal->id; ?>" value="<?php echo $ProVal->id; ?>"  /></td>
                    <td align="center"><?php echo $product_code; ?></td>
                    <td align="center"><?php if(count($ProVals)): foreach($ProVals as $ProVal): echo $ProVal->product_name; endforeach; endif; ?></td>
                    <td align="center"><?php
