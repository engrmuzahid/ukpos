...
function init_table_sorting()
{
 ...
 <table id="title_bar">
    ...
    <tr>
		...
		<td id="title"><?php echo CHtml::link('Customer Type', array('add'))?></td>
	</tr>
  </tbody>
</table>
		...
		<td id="item_table">
            ...
            <tr>
                <td width="5%"><input type="checkbox" name="<?php echo 'checkbox_'.$model->id; ?>" id="<?php echo 'checkbox_'.$model->id; ?>" value="<?php echo $model->id; ?>"  /></td>
					...
					<td><?php echo $model->discount_ratio."(%)"; ?></td>
                    <td width="15%" style="margin-left:10px;">
					<a href="<?php echo Yii::app()->request->baseUrl.'/index.php/customer_type/edit/'.$model->id; ?>" title="Edit"><img src="<?php echo Yii::app()->request->baseUrl.'/public/images/edit.png'; ?>" alt="Edit" title="Edit" border="0" /></a> | 
					<a onclick="return confirmSubmit()" href="<?php echo Yii::app()->request->baseUrl.'/index.php/customer_type/delete/'.$model->id; ?>" title="Delete"><img src="<?php echo Yii::app()->request->baseUrl.'/public/images/delete.png'; ?>" alt="Delete" title="Delete" border="0" /></a>
					</td>
            </tr>
