<script>
    function getQtyTotal()
    {
        ...
        for (var i = 1; i <= mlt; i++)
        {
            ...
            var box = document.getElementById("box_" + i).value;
            var boxItem = document.getElementById("item_" + i).value;
            ...
            $("#price_" + i).val((pprice * qty) / boxItem);
            ...
            profitTotal += (profitMargin * box * pprice) / 100;
        }
...
//        var sell_price = sell_price + (vat/100)*sell_price;
    ...
    $(document).ready(function () {
        ...
        $(".itemBox").blur(function (e) {
            getQtyTotal();
        })
        $(".boxItem").blur(function (e) {
            getQtyTotal();
        })
//        
//        $(".profitMargin").blur(function(e){
...
<?php echo CHtml::beginForm(Yii::app()->request->baseUrl . '/purchase/actionAddBox', 'post', array('name' => 'frm_soft', 'enctype' => 'multipart/form-data')); ?>
<table align="center" width="95%" style="margin-bottom:10px;margin-left:10px;"> 
    ...
    <tr height="25" style="font-weight:bold; margin-bottom:10px;">
        ...
        <td width="15%"><?php echo "&nbsp;" . CHtml::submitButton('Add Box', array('class' => 'buttonGreen', 'onClick' => 'MyCardBox()')); ?></td>
                    ...
                    <table style="width: 935px">
                        ...
                        foreach ($cart as $item):
                            ...
                            <tr style="font-size:12px;">                                
                                ...
                                <td><input type="text"  class="itemBox" value="0" style="width:40px;height:25px;border:1px solid #CCC;" data-row="<?php echo $i; ?>" id="box_<?php echo $i ?>" /></td>
                                <td><input type="text" class="boxItem" value="0" style="width:40px;height:25px;border:1px solid #CCC;" data-row="<?php echo $i; ?>" id="item_<?php echo $i ?>" /></td>

                                <td align="center"><?php
                                    echo CHtml::textField('price2[]', $item->p_price, array('id' => 'price' . $i, 'class' => 'buyPrice', 'style' => 'width:40px;height:25px;border:1px solid #CCC;', 'data-row' => $i));
                                    ?></td>

                            <input type="hidden" name="price[]" value="<?php echo $item->p_price; ?>" id="price_<?php echo $i ?>"/>
                            ...
                            <td align="center"><?php
                                ...
                                ?></td>
                            <td align="center"><?php echo CHtml::textField('quantity[]', 0, array('id' => 'quantity' . $i, 'class' => 'productQty', 'data-row' => $i, 'style' => 'width:40px;height:25px;border:1px solid #CCC;')) ?></td>
                            ...
                            <td  class="remove">
                                ...
                                <?php echo CHtml::link('X', array('/purchase/removeBox/' . $item->id)); ?>
                            </td>
                            </tr>
                            <?php
                            ...
                            $total_profit += ($item->profit / 100) * $item->quantity;
                            $i = $i + 1;
                        endforeach;
                        ?>
                        ...
                        <tr><td colspan="5" align="right">
                                <strong>Total Profit: </strong></td><td  align="center"><div id = "totalProfit"><?php echo "&pound; " . number_format($total_profit, 2); ?></div> 
                            </td>
                        </tr>
                    </table>		
                </div>
