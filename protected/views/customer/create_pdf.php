<table id="contents">
    <tbody>
        <tr>
            <td id="commands" colspan="3">
                ...
                ?>
                <table border="0" width="100%" cellpadding="0" cellspacing="0"  style="font-family: Arial; font-size:12px;margin-bottom:10px; margin-left:10px;">
                    <?php if (count($companys)): foreach ($companys as $company): ?>
                            <tr>
                                <td width="10%" rowspan="2" valign="top">
                                    <img src="<?php echo Yii::app()->request->baseUrl . '/public/photos/company/' . $company->company_logo; ?>" height="70" alt=""  />
                                </td>
                                <td width="60%">
                                ...
                                <td width="30%" style="border: 1px solid #000;padding: 5px;text-align: justify; font-size:8px;">
            ...
            <?php echo "Invoice # " . $posValue->invoice_no . "<br/>Date: " . date('M d, Y', strtotime($posValue->order_date)); ?>
                                                    </p>
                                                </td>
    ...
    <?php endforeach; ?>
                    ...
                    <?php endif; ?>
                <table width="100%" cellpadding="2" cellspacing="3" border="1" style="margin-left:5px; border-collapse:collapse;font-family: Arial; font-size:12px;" >
    ...
    foreach ($model_products as $posProductValue):
        ...
        $_product = Product::model()->find($prod1);
        ...
        ?>
                            <tr <?php if ($i % 2 == 0): ?> class="alternate-row" <?php endif; ?>>
                                <td align="left" style="margin-left:2px;">
                                    ...
                                    &nbsp;<?php echo $posProductValue->quantity; ?> <span style="width:5px; display:inline-block"><?php echo $vat_amount > 0 ? '*' : ''; ?></span>
                                </td>
                                <td style="margin-left:2px;">&nbsp;<?php echo ucwords($_product->product_name); ?></td>
                                <td align="right" style="margin-right:5px;" ><?php echo '&pound; ' . number_format($_amount, 2); ?>&nbsp;</td>
...
?>
                        ...
                        <td align="right" style="margin-right:5px;"><?php echo '&pound; ' . number_format($sub_total_amount, 2); ?>&nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="right"><?php echo '&pound; ' . number_format($sub_total_amount + $total_vat_amount, 2); ?>&nbsp;</td>
                    </tr>
                    <tr>
