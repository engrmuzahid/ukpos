<?php echo CHtml::beginForm()?>
		...
		<tr>
			...
			<td><?php echo CHtml::activeTextField($model, 'unit_type', array('style' => 'width:200px;height:25px;border:1px solid #CCC;'))?></td>
			<td>
            <div class="markcolor"><?php echo CHtml::error($model,'unit_type'); ?></div>
           </td>
		</tr>
