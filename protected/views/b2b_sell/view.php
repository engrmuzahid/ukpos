                ...
                <div id="ptable3">
                    ...
                    <table width="90%" cellpadding="2" cellspacing="3" border="1" style="margin-left:5px; border-collapse:collapse;font-family:Verdana; font-size:11px;" >
                        <?php if (count($model_products)): ?>
                            <tr>
                                <td width="7%"  align="left">&nbsp;<strong>QTY</strong></td>
                                <td width="53%" align="left">&nbsp;<strong>DESCRIPTION</strong></td>
				...
				$vat_amount = $posProductValue->vat;
                                ...
                                <tr <?php if ($i % 2 == 0): ?> class="alternate-row" <?php endif; ?>>
                                    <td align="left" style="margin-left:2px;">
                                        ...
                                        &nbsp;<?php echo $posProductValue->quantity; ?>
                                    </td>
                                    ...
                                    <td align="right" style="margin-right:5px;">
                                        ...
                                        <?php endif; ?>
                                        <?php echo '&pound; ' . number_format($_amount_total, 2); ?>&nbsp;</td>
                                </tr>
                                <?php
                                $i = $i + 1;
                            endforeach;
                        ...
                        ?>
                        <tr>
                            <td rowspan="6" valign="middle" colspan="2" align="left">
                                <br />
                                <?php
                        ...
                        <tr>
                            <td align="right" style="margin-right:5px;"><strong>Discount</strong>&nbsp;</td>
