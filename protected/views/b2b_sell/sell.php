...
//        $("#search_product").live("keyup", function e() {
//              $("#product_list").html("");
//          
//            if ($("#customer_id").val() != null || $("#customer_id").val() != "" || $("#customer_id").val() != 0) {
...
//        
        ...
        $("#print_order").click(function (e) {
            ...
            var url = base_url + '/b2b_sell/addSell';
    ...
    <div id="customer_listing">
        <table  id="item_table" style="width: 100%;">
            ...
            foreach ($org_customers as $customer):
                ?>
                <tr>
                    <td style="line-height: 27px;cursor: pointer;" class="customer_radiobox" data-name="<?php echo $customer['customer_name']; ?>"  data-value="<?php echo $customer['id']; ?>" >
                        <b><?php echo $customer['customer_name']; ?>   </b> <br/>
...
<form method="post" id="frm_order" action="<?php echo Yii::app()->baseUrl ?>/b2b_sell/addOrder">
    ...
    <input type="hidden" name="cash_sell" value="1" />
    ...
    <div class="scroller" id="cart_section">        
        <div id="total_price">
            <div style="float: left; width: 25%">
                ...
                <input type="button"  class="buttonGreen"  style="width: 100%; float: right;margin-top: 5px;" onclick="location = '<?php echo Yii::app()->baseUrl ?>/customer/cash_receiable_report'" value=" Report " />    <br/>
            </div>
            ...
            <div style="float: right; width: 30%">
                <?php if ($user['is_suspend'] == '1'): ?>
                    ...
                    <input type="button" style="width: 100%; float: right;" id="discountBtn" class="buttonGreen" value=" DISCOUNT " /> 
                <?php else: ?>
        ...
        <div id="cart_header" style="padding: 5px 0;min-height: 30px;">
            <table style="float: left; width: 30%; text-align: left;display: none;">
                <tr>
            ...
            <table style="float: right; width: 70%;display: none;">
                <?php if ($user['payment_check'] == '1'): ?>
                    <tr>
                        <td style="float: right;"> Cheq:  <input class="payment" style="width:70%;float: left;" type="text" name="cheque_payment" id="check_payment" value="<?php echo $old_order ? $old_order->cheque_payment : '' ?>" /></td>
                        <td><input type="button" style="width: 100%; float: right;" id="discountBtn_pre" class="buttonGreen" value=" DISCOUNT " />  </td>
                    </tr> 
                    <tr> 
                        <td colspan="2">
