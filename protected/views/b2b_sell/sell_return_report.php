                ...
                <div id="ptable3">
                    <div id="table_holder">
                        ...
                        <table class="tablesorter" id="sortable_table" style="width:100%">
                            <?php if (count($model)): ?>
                                ...
                                <tr>
                                    ...
                                    foreach ($model as $posValue):
                                        ...
                                        if ($payment_return == 1): $p_return = "Cash";
                                        elseif ($payment_return == 2): $p_return = "Card";
                                        else: $p_return = "Payable Deduction";
                                        endif;
                                        ?>
                                    <tr style="font-family:Verdana; font-size:11px;">
                                        ...
                                        <td width="20%"><?php
                                            if (count($pros)): foreach ($pros as $pro): echo ucwords($pro->product_name);
                                                endforeach;
                                            endif;
                                            ?></td>
                                        ...
                                        <td width="5%"><?php echo $p_return; ?></td>
                                        <td  width="10%"><?php echo $posValue->reason; ?></td>
                                        <td  width="16%"><?php
                                            if (count($users)): foreach ($users as $user): echo ucwords($user->full_name);
                                                endforeach;
                                            endif;
                                            ?></td>
                                    </tr>
                            ...
                            <?php else: ?>
                                <tr><div id="message-red"><td colspan="9" class="red-left">No Sell Return Available  .. <a href="<?php echo Yii::app()->request->baseUrl . '/b2b_sell/sell_return_report/'; ?>">Search Again..</a></td></div></tr>
                            <?php endif; ?>
                        </table>
                    </div>
            </td>
