<?php echo CHtml::beginForm(Yii::app()->request->baseUrl.'/b2b_sell/sell_return', 'post', array('enctype' => 'multipart/form-data')); ?>
...
//            exit();
    ...
    <?php echo CHtml::beginForm(Yii::app()->request->baseUrl.'/b2b_sell/sellentry', 'post', array('enctype' => 'multipart/form-data')); ?>
...
<table style="margin-left:10px;" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <table>
                        ...
                        foreach ($cart as $item):
                            ...
                            <tr>
                                ...
                                <td  class="remove">
                                    <?php echo CHtml::link('X', array('/b2b_sell/sellremove/' . $item->id)); ?>
    ...
    <tr>
        ...
        <td>
            <?php echo CHtml::radioButton('payment_return', '', array('value' => 1)) . " Cash"; ?>
            <?php echo CHtml::radioButton('payment_return', '', array('value' => 2)) . " Card"; ?> 
            <?php echo CHtml::radioButton('payment_return', 'payment_return', array('value' => 0)) . " Payable Deduction"; ?>            
        </td>
        <td>
            <div class="markcolor"><?php //echo CHtml::error($model,'stock_in_date');    ?></div>
        </td>
