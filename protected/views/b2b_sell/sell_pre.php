            ...
            $.post(url, {'customer_id':$("#customer_id").val()}, function(resp){
                ...
                $.each(response, function(k, val){                    
                    ...
                    if(_product) {
                        ...
                        if(val.product_name != "")  _product.product_name = val.product_name;
                        if(_product) invoice_products[k++] = _product;
                    }
                });
...
<form method="post" id="frm_order" action="<?php echo Yii::app()->baseUrl ?>/b2b_sell/addSell">
    ...
    <input type="hidden" name="cash_sell" id="cash_sell" value="1" />
    <div class="scroller" id="cart_section">        
        <div id="total_price">
            ...
            <div style="float: right; width: 30%">
                ...
                <input type="button"  class="buttonGreen" style="width: 100%;" onclick="location='<?php echo Yii::app()->baseUrl ?>/customer/cash_receiable_report'" value=" Report " />    <br/>                
            </div>
