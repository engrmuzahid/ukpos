            ...
            <tr>
                <th>
                    <span>   <a href="<?php echo Yii::app()->request->baseUrl . '/product/screens/'; ?>" style="float:left;"><img src="<?php echo Yii::app()->request->baseUrl; ?>/public/images/displaysIcon.png" height="24" alt="Screens" title="Screens" align="absmiddle"></a>
                        <span> CHICKEN </span> </span>   <span style="float:right;margin-right: 8%;"> Price </span>    
                    </th>
    ...
    <?php if (count($models)): ?>
        <thead>
            <tr>
                <th>
                    <span>    
                        <span>CHICKEN</span> </span>    <a  style="float:right;text-align: right;" href="" onclick="window.location.reload();"><img src="<?php echo Yii::app()->request->baseUrl; ?>/public/images/reorder.jpg" height="24" alt="Screens" title="Screens" align="absmiddle"></a> <span style="float:right;margin-right: 8%;"> Price </span>    
                    </th>
