...
<script type="text/javascript">
    ...
    function screen_product() {
        var screen = $("#is_boucher").val();
        if (screen == "0") {
            $("#boucher_div").hide();
        } else {
            $("#boucher_div").show();
    ...
    $(document).ready(function () {
        ...
        $("#is_boucher").live("change", function () {
                screen_product();
        });
...
<table id="title_bar">
    <tbody>
        <tr>
            ...
            <td id="title"><?php echo CHtml::link('Item', array('index')) ?> → Edit Item</td>
        </tr>
    </tbody>
</table>
<table id="contents">
    <tbody><tr>
            ...
            <td style="background-color:#E9E9E9">
                ...
                <?php endif; ?>   
                <?php $this->renderPartial('_formedit', array('model' => $model, 'fullCategoryName' => $fullCategoryName, 'screens' => $screens,"screen_id"=>$screen_id)); ?>
            </td>
        </tr>
    </tbody></table>
