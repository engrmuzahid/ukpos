                        ...
                        <?php if (count($models)): ?>
                            ...
                            <tbody>
                                ...
                                foreach ($models as $model):
                                    ...
                                    $stock_product = Yii::app()->db->createCommand()->select('product_balance')
                                                    ->from('stock')
                                    ...
                                    <tr  style="font:Verdana; font-size:11px">
                                        ...
                                        <td width="10%"><?php  echo $stock_product['product_balance']; ?></td>
                                        <td width="15%"><?php  echo  $model->offer_quantity > 0  ?'&pound; ' . number_format( $model->offerPrice, 2).' / '.$model->offer_quantity : "N/A"; ?></td>
