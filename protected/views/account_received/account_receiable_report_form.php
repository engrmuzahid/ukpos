	...
	<tbody><tr>
     ...
     <?php echo CHtml::beginForm()?>		
        ...
        <tr>
			...
			<td width="15%"><?php echo CHtml::dropDownList('customer_id','customer_id', $list3, array('empty' => 'Select Customer', 'style' => 'width:150px;height:25px;border:1px solid #CCC;'));?></td>
			<td width="2%">&nbsp;</td>
