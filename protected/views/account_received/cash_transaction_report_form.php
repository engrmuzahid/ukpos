		...
		new JsDatePick({
			...
			dateFormat:"%Y-%m-%d"
             ...
             <?php
              ...
              ?>
   <?php $this->renderPartial('/layouts/site_top_menu', array('mainTab' => 'expense_info', 'activeTab' => 'cash_report')); ?>
...
<!-- CONTENT START -->
    ...
    <div class="portlet">
        <div style="margin-left:5px;"><h1>Cash Transaction Report</h1></div>
     <?php echo CHtml::beginForm()?>		
        ...
        <tr>
			...
			<td width="2%">&nbsp;</td>
			<th width="12%" valign="top"><?php echo CHtml::label('Mode', 'status')?>&nbsp;&nbsp;</th>
			<td width="15%"><?php echo CHtml::dropDownList('status','status', $list3, array('empty' => 'Select Mode', 'style' => 'width:150px;height:29px;border:1px solid #CCC;'));?></td>
			<td width="2%">&nbsp;</td>
