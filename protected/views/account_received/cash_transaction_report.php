        ...
        <div style="margin-left:5px;"><h1>Cash Transaction Report</h1></div>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" id="box-table-a" summary="Employee Pay Sheet">
               <?php if(count($model)): ?>
                ...
                <?php  else: ?>
				<tr><div id="message-red"><td colspan="4" class="red-left">No Transaction Amount Available Yet .. <a href="<?php echo Yii::app()->request->baseUrl.'/account_received/cashtrans_report/'; ?>">Search Again..</a></td></div></tr>
                <?php endif; ?>
				</table>
          </div>
<!--  END #PORTLETS -->  
