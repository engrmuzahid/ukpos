...
<!-- CONTENT START -->
    ...
    <div class="portlet">
        <div style="margin-left:5px;"><h1>Received Products</h1></div>
				
                <table border="0" width="100%" cellpadding="0" cellspacing="0"  style="margin-left:10px; margin-bottom:5px;">
                    <tr>
                     <td colspan="2" align="left">
                         <a href="<?php echo Yii::app()->request->baseUrl.'/receive_delivery/add'; ?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/public/images/add.gif" alt="<?php echo "#"; ?>" border="0" align="absmiddle"/></a>
                         &nbsp;
                         <?php echo CHtml::link('Received Products', array('add'))?>
                     </td>
                    </tr>
				</table>
				...
				<tr>
                    ...
                    <th width="15%" scope="col">Storage Period</th>
                    ...
                    <th width="10%" scope="col">Remaining</th>
                ...
                <?php $i=1; foreach($models as $model): 
					...
					$days = (strtotime($model->expire_date) - strtotime(date("Y-m-d"))) / (60 * 60 * 24);
					if($days <= 0):
					$remaining_date = "<font color='red'>(Warranty expired)</font>";
					else:
					$remaining_date = "(".$days." days left)";
					endif;
				...
				<tr <?php if($i %2 == 0): ?> class="alternate-row" <?php endif;?>>
                    ...
                    <td><?php echo $remaining_date; ?></td>
                    <td class="options-width">
					<a onclick="return confirmSubmit()" href="<?php echo Yii::app()->request->baseUrl.'/receive_delivery/delete/'.$model->id; ?>" title="Delete" class="delete2_icon"></a>
					<!--<a href="<?php echo Yii::app()->request->baseUrl.'/receive_delivery/edit/'.$model->id; ?>" title="Edit" class="edit_icon"></a>-->
                ...
                <?php else: ?>
				<tr><div id="message-red"><td colspan="8" class="red-left">No Delivery Information Available.</td></div></tr>
                <?php endif; ?>
				</table> 
<!--  END #PORTLETS -->  
   </div>
