	...
	<tbody><tr>
     ...
     <?php echo CHtml::beginForm()?>		
        ...
        <tr>
			...
			<td width="2%">&nbsp;</td>
			<th width="12%" valign="top"><?php echo CHtml::label('Shipment Id', 'chalan_id')?>&nbsp;&nbsp;</th>
			<td width="15%"><?php echo CHtml::dropDownList('chalan_id','chalan_id', $list4, array('empty' => 'Select Shipment Id', 'style' => 'width:150px;height:25px;border:1px solid #CCC;'));?></td>
