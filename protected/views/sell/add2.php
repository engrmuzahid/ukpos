...
<script type="text/javascript">
	...
	function getDiscountValue2()
	{
		...
		function MyCart2()
		{
			...
			oForm.action="<?php echo Yii::app()->request->baseUrl.'/sell/add2'; ?>";
			oForm.post="post";
			oForm.submit();
		}
		...
		{
			var oForm = document.frm_soft;
			oForm.action="<?php echo Yii::app()->request->baseUrl.'/sell/suspend2'; ?>";
			oForm.post="post";
			oForm.submit();
		}
		...
		{
			var oForm = document.frm_soft;
			oForm.action="<?php echo Yii::app()->request->baseUrl.'/sell/sell_cancel2'; ?>";
			oForm.post="post";
			oForm.submit();
		}
...
<script language="javascript">
 $().ready(function() {
	$("#product_code").autocomplete('<?php echo Yii::app()->request->baseUrl . '/public/product_list.php'; ?>', {  //we have set data with source here
            ...
            <?php $this->renderPartial('_entryform2', array('model' => $model))?>
