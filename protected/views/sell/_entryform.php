...
//	});
		...
		tPayment            = cash_payment*1 + cheque_payment*1 + credit_card_payment*1;
                ...
                if(tPayment > 99999) {
                    $("#cash_payment,#cheque_payment,#credit_card_payment").val('0');
                    return false;                    
                } else {
 ...
 <?php echo CHtml::beginForm(Yii::app()->request->baseUrl.'/sell/add','post',array('name'=>'frm_soft', 'id'=>'frmAddSell', 'enctype'=>'multipart/form-data')); ?>
        ...
        <td id="register_items_container">
			<table id="title_section">
				<tbody><tr>
					...
					<td id="show_suspended_sales_button"><a href="<?php echo Yii::app()->request->baseUrl.'/sell/suspended/'; ?>" title="Suspended Sales"><div class="small_button">Suspended Sales</div></a></td>
				</tr>
			</tbody></table>
									...
									<table>							
                                            ...
                                            $i = 1;				
                                             foreach ($cart as $item):
                                                     ...
                                                     if($i==1): $style = "style='width: 283px;font-size:14px;font-weight:bold;'"; else: $style = "style='width: 283px;'"; endif;
											 ?>
                                            <tr id="reg_item_top">
												<td style="width: 68px;" id="reg_item_del"><?php echo CHtml::link('Delete', array('/sell/remove/'.$item->id)); ?></td>
												<td <?php echo $style;?>><?php echo ucwords($product_name); ?></td>
			...
			<div id="overall_sale">				
				<div id="suspend_cancel">
					<div id="suspend" style="visibility: visible;">
                     <?php echo CHtml::button('Suspend Sale' ,array('id' => 'suspend_sale_button', 'name' => 'pay_now2', 'style' => 'width:105px; height:26px;', 'onClick' => 'MySuspend()')); ?>			
					</div>
					<div id="cancel" style="visibility: visible;">	
                     <?php echo CHtml::button('Cancel Sale' ,array('id' => 'cancel_sale_button', 'name' => 'pay_now', 'style' => 'width:90px; height:26px;', 'onClick' => 'MySellCancel()')); ?>											
                    </div>
				</div>
				<div id="sale_details">
                    ...
                    <?php      	  
					 ...
					 $amount_ttotal = $amount_sub_total + $vat_total;
						...
						<tr>
							...
							<td class="right"><div id = "discountTotal">&pound; 0.00</div></td>
						</tr>
                    </tbody></table>
