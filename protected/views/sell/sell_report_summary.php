<div align="center" style="margin: 20px;">
    ...
    <table cellspacing="0" style="font-size: 12px; font-family: Verdana">
        ...
        <?php $total_cash = $total_cheque = $total_card = $total_vat = $total_change_amount = 0; ?>
        <?php $cnt=0; $total=0;  foreach($orders as $date=>$order )  :   ?>
            <?php $change_amt = $order['total_paid_amount'] > $order['total_amount'] ? $order['total_paid_amount'] - $order['total_amount'] : 0;
            $total_change_amount +=$change_amt;
            ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <span style="float:right; font-weight: bold">TOTAL:&pound;<?php echo  number_format((($order['cash_amount']-$change_amt)+$order['card_amount'] +$order['cheque_amount']),2) ?> </span>
                </td>
            </tr>
        ...
        <?php endforeach; ?>
            ...
            <tr>                
                <td align="right">
                    ...
                    <hr style="width: 100%" />
                    <b>Total Amount : &pound;<?php echo number_format($total_cash+$total_card+$total_cheque,2); ?></b> 
