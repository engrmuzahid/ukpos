            ...
            <tr>
                <td width="5%"><input type="checkbox" name="<?php echo 'checkbox_'.$model->id; ?>" id="<?php echo 'checkbox_'.$model->id; ?>" value="<?php echo $model->id; ?>"  /></td>
                    ...
                    <td width="15%" style="margin-left:10px;">
                     <a href="<?php echo Yii::app()->request->baseUrl.'/index.php/sell/view/'.$posValue->invoice_sl; ?>" title="Show">Show</a> | 
                    <!-- <a href="<?php echo Yii::app()->request->baseUrl.'/index.php/sell/edit/'.$posValue->invoice_sl; ?>" class="edit_icon" title="Edit"></a>-->
                     <a  onclick="return confirmSubmit()" href="<?php echo Yii::app()->request->baseUrl.'/index.php/sell/delete/'.$posValue->invoice_sl; ?>"  title="Delete">Delete</a>
                    </td>
            </tr>
