...
//    });
    ...
    function show_categories() {
        ...
        $.each(categories, function (k, category) {
            content = '<div class="sub_category category' + category.id + '" -id="' + category.id + '" parent-id="' + category.id + '"  data-id="' + category.id + '" id="category_item_' + category.id + '"><img  alt="' + category.category_name + '" src="' + base_url + '/images/categories/' + category.image + '" /></div>';
