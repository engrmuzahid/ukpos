...
<table id="contents" style="width:0px; font-size:12px;">
            ...
            <td id="commands" colspan="3">
                ...
                <div id="ptable3">       
                    ...
                    <table border="0" width="250" align="center" cellpadding="0" cellspacing="0"  style="margin-bottom:10px; margin-left:10px;">
                                ...
                                <?php echo ucwords($company->company_name) . "<br/> "; ?>
    ...
    <?php endforeach;
        ...
        <?php endif; ?>
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        <h6><?php echo "No. ITEMS SOLD " . count($model_products); ?></h6>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="center">        
                                        <img src="<?php echo Yii::app()->request->baseUrl . '/public/'; ?>barcode.php?barcode=<?php echo $posValue->invoice_no; ?>&width=250&height=65"> 
                                    </td>
                                </tr>
        <?php
        $full_name = "";
        ...
        ?>
                                <tr>
                                    <td colspan="2" align="center"><?php echo date('M d, Y', strtotime($posValue->order_date)); ?>  </td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="center"><?php echo " Served by # " . ucwords($full_name); ?>  </td>
                                </tr>
                                <tr>
