...
<table id="title_bar">
    ...
    <tr>
		...
		<td id="title">Suspended Point of Sell List
	...
	<tbody><tr>
		...
		<td id="item_table">
            ...
            <tr>
                ...
                <th width="15%" class="rightmost header">Delete</th>
            </tr>
            </thead>
            <tbody>
            ...
            <tr>
                    ...
                    <td><a href="<?php echo Yii::app()->request->baseUrl.'/index.php/sell/unsuspend/'.$posValue->id; ?>" class="buttonGreen" title="Unsuspend">Unsuspend</a></td>
                    ...
                    <td><a  onclick="return confirmSubmit()" href="<?php echo Yii::app()->request->baseUrl.'/index.php/sell/delete2/'.$posValue->id; ?>" class="buttonGreen" title="Delete">Delete</a></td>
            </tr>
...
<div id="feedback_bar"></div>
    ...
    $(document).ready(function(){
        $("#filter_day").change(function(e){
            if($(this).val() != "")
                location = '<?php echo Yii::app()->baseUrl ?>/sell/suspended/?filter_day='+$(this).val();
            else location = '<?php echo Yii::app()->baseUrl ?>/sell/suspended/';
        });
    });
    </script>
