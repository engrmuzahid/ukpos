   ...
   <?php echo CHtml::beginForm('/pos_uk/index.php/requisition/entry','post',array('enctype'=>'multipart/form-data')); ?>
   <?php 
...
<?php echo CHtml::beginForm('','post',array('enctype'=>'multipart/form-data')); ?>
                ...
                <?php foreach ($cart as $item):
				 ...
				 ?>
                    <tr>
                        ...
                        <td  class="remove">
                            <?php echo CHtml::link('X', array('/requisition/remove/'.$item->id)); ?>
		...
		<tr>
			<th valign="top"><?php echo CHtml::label('Requisition Date', 'requisition_date')?>&nbsp;&nbsp;</th>
			<td><?php echo CHtml::textField('requisition_date', '', array('style' => 'width:200px;height:25px;border:1px solid #CCC;'))?></td>
			<td>
        ...
        <tr><td colspan="3">&nbsp;</td></tr>
		<tr>
			<th valign="top"><?php echo CHtml::label('Submit By', 'requisition_submitted_by')?>&nbsp;&nbsp;</th>
            <td><?php echo CHtml::dropDownList('requisition_submitted_by','requisition_submitted_by', $user_list, array('empty' => '----- Select User -----', 'style' => 'width:200px;height:25px;border:1px solid #CCC;')); ?></td>
			<td>
            <div class="markcolor"><?php //echo CHtml::error($model,'stock_in_date'); ?></div>
           </td>
		</tr>
        <tr><td colspan="3">&nbsp;</td></tr>
		<tr>
			<th valign="top"><?php echo CHtml::label('Requisition Note', 'note')?>&nbsp;&nbsp;</th>
