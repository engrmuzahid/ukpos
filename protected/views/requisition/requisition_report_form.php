...
<!-- CONTENT START -->
    ...
    <div class="portlet">
        <div style="margin-left:5px;"><h1>Requisition Report</h1></div>
     <?php echo CHtml::beginForm()?>		
        <table style="margin-left:10px;" border="0" cellpadding="0" cellspacing="0">
        <tr height="10"><td colspan="3">&nbsp;</td></tr>
        <tr>
			<th width="15%" valign="top"><?php echo CHtml::label('Start Date', 'start_date')?>&nbsp;&nbsp;</th>
			<td width="25%"><?php echo CHtml::textField('start_date', '', array('style' => 'width:200px;height:25px;border:1px solid #CCC;'))?></td>
			<td width="2%">&nbsp;</td>
			<th width="15%" valign="top"><?php echo CHtml::label('End Date', 'end_date')?>&nbsp;&nbsp;</th>
			<td width="25%"><?php echo CHtml::textField('end_date', '', array('style' => 'width:200px;height:25px;border:1px solid #CCC;'))?></td>
			<td width="2%">&nbsp;</td>
