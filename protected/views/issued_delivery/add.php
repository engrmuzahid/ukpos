   <?php $this->renderPartial('/layouts/site_top_menu', array('mainTab' => 'issued_delivery', 'activeTab' => 'add')); ?>
...
<script type="text/javascript">
	window.onload = function(){
		new JsDatePick({
			useMode:2,
			target:"Issued_Delivery_issued_do_date",
			dateFormat:"%Y-%m-%d"
		});
	};
	...
	function getTotal()
	{
        ...
        <div style="margin-left:5px;"><h1><?php echo CHtml::link('Issued Delivery', array('index'))?> → Entry Information</h1></div>
