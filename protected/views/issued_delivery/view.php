...
<!-- CONTENT START -->
    ...
    <div class="portlet">
       ...
       <div id="ptable3">
        <div style="margin-left:15px;"><h1>Issued Delivery Details</h1></div>
		
		<?php   if(count($models)): foreach($models as $model):
					  $issued_do_id   = $model->id;
				      $storage_party_id   = $model->storage_party_id;
					  $q1 = new CDbCriteria( array( 'condition' => "id = '$storage_party_id'",) ); 	
					  $q3 = new CDbCriteria( array( 'condition' => "issued_do_id = '$issued_do_id'",) ); 					  					 
                      $Sparties = Storage_Party::model()->findAll( $q1 );
                      $Iproducts = Issued_Delivery_Product::model()->findAll( $q3 );

		  ?>
       <table border="0" width="90%"  cellpadding="0" cellspacing="0"  style="margin-bottom:10px; margin-left:15px;">  
        <tr>
        <td width="20%"><strong><?php echo 'Issued Delivery Id'; ?></strong><span class="markcolor"></span></td>
        <td width="5%" align="center" valign="top">:</td>
        <td width="20%" align="left"><?php echo $model->id; ?></td>
        <td width="5%" align="center" valign="top">&nbsp;</td>
		...
		<tr>
        <td width="20%"><strong><?php echo 'Delivery Date'; ?></strong><span class="markcolor"></span></td>
        <td width="5%" align="center" valign="top">:</td>
        <td width="20%" align="left"><?php echo date('M d, Y', strtotime($model->issued_do_date)); ?></td>
        <td width="5%" align="center" valign="top">&nbsp;</td>
        <td width="20%"><strong><?php echo 'Note'; ?></strong><span class="markcolor"></span></td>
        <td width="5%" align="center" valign="top">:</td>
        <td width="20%" align="left"><?php echo $model->note; ?></td>
        <td width="5%" align="center" valign="top">&nbsp;</td>
        </tr>        
        <tr><td colspan="8">&nbsp;</td></tr>
        </table>
       <?php endforeach; endif; ?>
                ...
                <?php $i = $i + 1;
				 ...
				 endforeach; ?>
                <tr><td colspan="6" align="right"><strong>Grand Total: </strong></td><td ><?php echo "TK. ".$amount_sub_total; ?></td></tr>
                <?php else: ?>
