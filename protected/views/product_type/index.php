...
<table id="title_bar">
    ...
    <tr>
		...
		<td id="title"><?php echo CHtml::link('Subcategory', array('add'))?></td>
	</tr>
  </tbody>
</table>
	...
	<tbody><tr>
		...
		<td id="item_table">
            ...
            <tr>
					...
					<a href="<?php echo Yii::app()->request->baseUrl.'/index.php/product_type/edit/'.$model->id; ?>" title="Edit"><img src="<?php echo Yii::app()->request->baseUrl.'/public/images/edit.png'; ?>" alt="Edit" title="Edit" border="0" /></a> | 
					<a onclick="return confirmSubmit()" href="<?php echo Yii::app()->request->baseUrl.'/index.php/product_type/delete/'.$model->id; ?>" title="Delete"><img src="<?php echo Yii::app()->request->baseUrl.'/public/images/delete.png'; ?>" alt="Delete" title="Delete" border="0" /></a>
					</td>
            </tr>
