...
<!-- CONTENT START -->
    ...
    <div class="portlet">
        <div style="margin-left:5px;"><h1>Expense Category Information</h1></div>
				
                <table border="0" width="100%" cellpadding="0" cellspacing="0"  style="margin-left:10px; margin-bottom:5px;">
                    <tr>
                     <td colspan="2" align="left">
                         <a href="<?php echo Yii::app()->request->baseUrl.'/expense_category/add'; ?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/public/images/add.gif" alt="<?php echo "#"; ?>" border="0" align="absmiddle"/></a>
                         &nbsp;
                         <?php echo CHtml::link('Expense Category', array('add'))?>
                     </td>
                    </tr>
				</table>
				...
				<tr>
                    ...
                    <th width="30%" scope="col">Category Name</th>
				...
				<tr <?php if($i %2 == 0): ?> class="alternate-row" <?php endif;?>>
					...
					<a href="<?php echo Yii::app()->request->baseUrl.'/expense_category/edit/'.$model->id; ?>" title="Edit" class="edit_icon"></a>
					<a onclick="return confirmSubmit()" href="<?php echo Yii::app()->request->baseUrl.'/expense_category/delete/'.$model->id; ?>" title="Delete" class="delete2_icon"></a>
					</td>
				</tr>
                <?php $i = $i + 1; endforeach; ?>
				<tr> <td align="right" colspan="5"><?php $this->widget('CLinkPager', array('pages' => $pages,)); ?></td></tr>
                <?php else: ?>
				<tr><div id="message-red"><td colspan="5" class="red-left">No Expense Category Available.</td></div></tr>
                <?php endif; ?>
				</table> 
<!--  END #PORTLETS -->  
   </div>
