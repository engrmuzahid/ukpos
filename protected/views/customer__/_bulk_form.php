...
<?php if (count($model)): ?>
    <table border="0" width="90%"  cellpadding="0" cellspacing="0" style="margin-bottom:10px; margin-left:5px;"> 
        ...
        foreach ($model as $new_model):
            $model = (object) $new_model;
            ...
            <tr><td colspan="8">&nbsp;</td></tr>
            <?php
            $total_amount += $model->amount_grand_total;
        ...
        <tr>
            ...
            <td width="5%" align="center" valign="top">:</td>
            <td width="20%" colspan="6" align="left"><?php echo "&pound; " . $total_amount; ?></td>
            <td width="5%" align="center" valign="top">&nbsp;</td>
        </tr>
        <tr><td colspan="8">&nbsp;</td></tr>
    </table>
    <table border="1" width="90%"  cellpadding="0" cellspacing="0" style="font:Verdana; font-size:11px;border-collapse:collapse;margin-bottom:10px; margin-left:5px;">  
        ...
        <?php if (count($model2)): ?>
            ...
            $i = 1;
            $amount_sub_total = 0;
            foreach ($model2 as $new_model2):
                $data = (object) $new_model2;
        ...
        <tr>
            <td align="center">&nbsp;</td>
            <td align="center"><strong>Paid Amount: </strong></td><td align="center" ><?php echo "&pound; " . number_format($paid_amount, 2); ?></td>
            <td align="center"><strong>Due Amount: </strong></td><td align="center" ><?php
                $due_total = $total_amount - $paid_amount;
                echo "&pound; " . number_format($due_total, 2);
                ?></td>
        </tr>
        <tr><td colspan="5">&nbsp;</td></tr>
    </table>
    <?php echo CHtml::beginForm(Yii::app()->request->baseUrl . '/customer/receive_bulk_add', 'post', array('id' => 'frm_soft', 'name' => 'frm_soft', 'enctype' => 'multipart/form-data')); ?>
        ...
        <tr>
            ...
            <td valign="top">
                ...
                <div id="check_payment_date" style="margin-top: 10px;display: none;">
                    <input type="text" name="confirm_date" placeholder="Banking Date" id="confirm_date" style="width:160px;"/>
               <br/>
             </div>
                <br/><textarea name="notes"  placeholder="Please write comments..." rows="5" style="width:310px;padding: 5px;"></textarea>
            </td>
            <td>
    ...
    <table style="margin-left:20px;"> 
        ...
        <tr>
            ...
            <td valign="top">
                ...
                <input type="hidden"  name="invoice_no" id="invoice_no" value="<?php echo $invoices; ?>" />
                <input type="hidden"  name="amount_grand_total" id="amount_grand_total" value="<?php echo $total_amount; ?>" />
