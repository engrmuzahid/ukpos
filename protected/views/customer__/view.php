    ...
    <tr>
		<td id="title_icon">
			<img src="<?php echo Yii::app()->request->baseUrl; ?>/public/images/giftcards.png" alt="title icon">
                ...
                <td id="title">Customer Details <span id="printCustomer" data-id="<?php echo $model->id; ?>" style="float: right;"> <img  src="<?php echo Yii::app()->request->baseUrl . '/public/images/print.png'; ?>" alt="print Customer" title="Print Customer"  /></span></td>
	</tr>
  </tbody>
</table>
<table id="contents">
