                        ...
                        <?php if (count($model)): ?>
                            ...
                            foreach ($model as $customer_id => $posValues):
                                ...
                                <tbody class="details_<?php echo $customer_id; ?>" style="display: none">
                                    <tr>
                                        <th width="15%" style="background: #06c !important;"  scope="col">Invoice No</th>                                                
                                    ...
                                    <?php foreach ($posValues as $posValue): ?>
                                       ...
                                       if($due >0):     ?>
                                        ...
                                        <tr style="font:Verdana; font-size:11px">
                                            ...
                                            <td>   <input type="checkbox" class="invoice_number" name="invoice_number[]" data-value="<?php echo $due; ?>" value="<?php echo $posValue->invoice_no; ?>"> <a href="<?php echo Yii::app()->request->baseUrl . '/sell/view/' . preg_replace("/[^0-9]/", '', $posValue->invoice_no); ?>" target="_blank"><?php echo $posValue->invoice_no; ?></a></td>                                            
