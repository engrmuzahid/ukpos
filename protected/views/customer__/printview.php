...
<html lang="en">
    <head>
        <link href="<?php echo Yii::app()->request->baseUrl; ?>/public/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
        <style type="text/css">
            .border-all{
    ...
    <body>
        <div  class="container" style="margin-top:100px;">
            <div class="row  border-all">
                <div class="col-md-12 badge-default text-center text-white">
                    <h2>MEMBERSHIP APPLICATION</h2>
                </div>
                <div class="col-md-12 text-center" style="background-color: rgba(0, 0, 0, 0.05);">
            ...
            <div class="row  border-all">
                ...
                <div class="col-md-5 text-left border-left">
            ...
            <div class="row  border-all">
                ...
                <div class="col-md-4 text-left border-left">
