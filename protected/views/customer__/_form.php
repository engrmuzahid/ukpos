...
<table border="0" style="margin-left:20px;" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td>
            <?php
            echo CHtml::activeDropDownList($model, 'order_day', array(
        ...
        <!-- <tr>
                    <td valign="top"><?php echo CHtml::activeLabel($model, 'username') ?><span class="markcolor">*</span></td>
            ...
            <div class="markcolor"><?php echo CHtml::error($model, 'username'); ?></div>
                    ...
                    <td>&nbsp;</td>
                    <td valign="top"><?php echo CHtml::activeLabel($model, 'password') ?><span class="markcolor"></span></td>
