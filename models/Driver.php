...
class Driver extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, address, phone, licence_no', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, name, address, phone, licence_no, deacription', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('deacription',$this->deacription,true);
