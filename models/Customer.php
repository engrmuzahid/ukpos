...
class Customer extends CActiveRecord {
    ...
    public function rules() {
        return array(
            ...
            array('business_name,joining_date,business_state,business_country, customer_photo, username, password,  email_address, contact_no2, birthday, home_street1, home_city, home_state, home_post_code, home_country, comment, status, order_day,credit_limit,pay_date', 'safe'),
